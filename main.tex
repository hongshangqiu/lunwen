...
\whusetup
  {
    info               =
      {
        title          = {基于检索增强、双源证据融合与结构化推理的软件运维故障诊断方法},
        title*         = {A Software Operations Fault Diagnosis Method Based on Retrieval Augmentation, Dual-source Evidence Fusion, and Structured Reasoning},
