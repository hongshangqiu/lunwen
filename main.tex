...
\whusetup
  {
    info               =
      {
        title          = {基于检索增强与多源证据融合的软件运维故障诊断方法},
        title*         = {A Software Operations Fault Diagnosis Method Based on Retrieval-Augmented Generation and Multi-Source Evidence Fusion},
        ...
        advisor-name   = {应时},
        direction      = {软件工程},
        keywords       = {大模型, 检索增强生成, 软件运维, 故障诊断, 根因分析},
        keywords*      = {Large Language Model, Retrieval-Augmented Generation, Software Operations, Fault Diagnosis, Root Cause Analysis},
        date           = {2026/04},
      },
    style              =
      {
