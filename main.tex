...
\whusetup
  {
    info               =
      {
        title          = {基于大模型与软件运行日志的\\运维故障诊断方法},
        title*         = {A Software Operations Fault Diagnosis Method Based on Large Language Models and Software Runtime Logs},
        ...
        advisor-name   = {应时},
        direction      = {软件工程},
        keywords       = {大语言模型, 软件运维故障诊断, 日志数据, 日志与监控指标融合分析},
        keywords*      = {Large Language Models, Software Operations Fault Diagnosis, Log Data, Log and Metric Fusion Analysis},
        date           = {2026/04},
      },
    style              =
      {
