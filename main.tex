...
\whusetup
  {
    info               =
      {
        title          = {基于日志与监控指标协同分析的软件运维故障诊断方法},
        title*         = {A Software Operations Fault Diagnosis Method Based on Log and Metric Collaborative Analysis},
        ...
        advisor-name   = {应时},
        direction      = {软件工程},
        keywords       = {大语言模型, 软件运维, 故障诊断, 日志分析, 监控指标},
        keywords*      = {Large Language Model, Software Operations, Fault Diagnosis, Log Analysis, Monitoring Metrics},
        date           = {2026/04},
      },
    style              =
      {
