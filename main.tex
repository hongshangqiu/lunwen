...
\whusetup
  {
    info               =
      {
        title          = {基于大模型与日志可观测数据的软件运维故障诊断方法},
        title*         = {A Software Operations Fault Diagnosis Method Based on Large Language Models and Log Observability Data},
        ...
        advisor-name   = {应时},
        direction      = {软件工程},
        keywords       = {大语言模型, 软件运维, 故障诊断, 可观测数据, 日志分析, 监控指标},
        keywords*      = {Large Language Models, Software Operations, Fault Diagnosis, Observability Data, Log Analysis, Monitoring Metrics},
        date           = {2026/04},
      },
    style              =
      {
