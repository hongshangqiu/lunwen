...
\whusetup
  {
    info               =
      {
        title          = {基于大模型与日志的软件运维故障诊断方法},
        title*         = {A Software Operations Fault Diagnosis Method Based on Large Language Models and Logs},
        ...
        advisor-name   = {应时},
        direction      = {软件工程},
        keywords       = {大语言模型, 软件运维故障诊断, 日志与监控指标融合分析},
        keywords*      = {Large Language Models, Software Operations Fault Diagnosis, Log and Metric Fusion Analysis},
        date           = {2026/04},
      },
    style              =
      {
